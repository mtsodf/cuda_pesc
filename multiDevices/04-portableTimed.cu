 ...
 *
 * Este exemplo e' igual ao anterior, tendo apenas os comandos para se aferir
 *   o tempo que cada GPU leva para executar sua tarefa.
 * 
 */
...
void* routine( void *pvoidData ) {
	...
	// copy the array 'd_c' back from the GPU to the CPU
...
int main( void ) {
	...
	printf( "Time thread%d: %3.1f ms\n", data[0].deviceID, data[0].time );
	printf( "--------------------------------------------------------\n" );
