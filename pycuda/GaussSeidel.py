...
def MatVec(A, b):
    ...
    func(cuda.InOut(A.indptr), cuda.InOut(A.indices), cuda.InOut(A.data), cuda.InOut(b), cuda.InOut(c), n,
        grid=grid, block=block)
...
print "Norma da Diferenca = ", np.linalg.norm(d-c)


print "Tempo Numpy SP = ", t4-t3, dt

print "Tempo Gpu DP = ", t2-t1
